        ...
        <div style={{ padding: "24px" }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: "26px", fontWeight: "800", color: "#c0392b", lineHeight: 1, fontFamily: "'Playfair Display', Georgia, serif" }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: "20px", fontWeight: "700", color: "#1a1a1a", fontFamily: "'Playfair Display', Georgia, serif" }}>
